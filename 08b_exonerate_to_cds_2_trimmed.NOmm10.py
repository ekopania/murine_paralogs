...
# NOTE: This version should NOT include mm10 reference sequence in final output fasta
...
# 5. Concatenates all chosen segements from a given protein and writes to file.
    ...
    # Retrieve alignments for every protein in the dataset.
        ...
        # Go through every target in the current protein.
            ...
            #    continue;
            # THE FILTER
            #NOT filtering by number of samples
...
mouse_aa_dir = "/mnt/beegfs/ek112884/murinae/PARALOG_PROCESSING/repro_genes-selected-cds-aa-trimmed/"
...
with open(log_file, "w") as logfile:
    ...
    #skip_file = "/mnt/beegfs/ek112884/murinae/PARALOG_PROCESSING/skip_exons.txt"
