...
# Generating the commands in the job file.
    ...
    skip_file = "/mnt/beegfs/ek112884/murinae/PARALOG_PROCESSING/scripts/mm10-exons-w-stops.txt";
    ...
    targets_file = "/mnt/beegfs/ek112884/murinae/PARALOG_PROCESSING/repro_exons_full.txt"
